...
Contributors: mueller, andrew
Donate link: http://paypal.me/PedigreeApp
Tags: csv, import, importer, meta data, meta, user, users, user meta,  editor, profile, custom, fields, delimiter, update, insert, role
...
******This plugin adds support for an additional role column so that when you import your users you can speficy their role as well. In fact it's required along with username and email.
